  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-green-400 text-primary-foreground hover:bg-green-400/90 border-green-500 border-b-4 active:border-b-2",
        secondaryOutline: "bg-white text-green-500 hover:bg-slate-100",

        danger:
          "bg-red-500 text-primary-foreground hover:bg-red-600/90 border-red-600 border-b-4 active:border-b-2",
        dangerOutline: "bg-white text-red-500 hover:bg-slate-100",

        super:
          "bg-indigo-500 text-primary-foreground hover:bg-indigo-600/90 border-indigo-600 border-b-4 active:border-b-2",
        superOutline: "bg-white text-indigo-500 hover:bg-slate-100",

        ghost:
          "bg-transparent text-slate-900 border-transparent border-0 hover:bg-slate-100",

        sidebar:
          "bg-transparent text-slate-900 border-2 border-transparent hover:bg-slate-100 transition-none",
        sidebarOutline:
